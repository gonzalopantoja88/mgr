INSERT INTO `factor_riesgos` (`id_factor_riesgo`, `nombre_factor_riesgo`) VALUES
(1, 'Procesos'),
(2, 'Talento humano'),
(3, 'Tecnología'),
(4, 'Infraestructura');

INSERT INTO `sistema_asociados` (`id_sistema_asociado`, `nombre_sistema_asociado`) VALUES
(1, 'Empresa'),
(2, 'Sistema general'),
...
INSERT INTO `variables` (`id_variable`, `nombre_variable`, `id_fk_sistema_asociado`) VALUES
(1, 'Tipo de empresa', 1),
...
INSERT INTO `despliegues` (`id_despliegue`, `nombre_despliegue`, `id_fk_variable`) VALUES
...
(123, 'Registros requeridos de control', 35),
(124, 'Climatología', 36),
...
(164, 'Investigación, desarrollo e innovación', 31),
...
INSERT INTO `categorias` (`id_categoria`, `nombre_categoria`, `id_fk_despliegue`) VALUES
(1, 'Privada', 1),
(2, 'Publica', 1),
(3, 'Mixta', 1),
(4, 'Microempresa', 2),
...
(67, 'Registros requeridos de gestion por procesos', 47),
...
(79, 'Registros requeridos de personas', 71),
...
(128, 'Registros requeridos de identificación y trazabilidad', 111),
...
(147, 'pH', 126),
(148, 'Temperatura', 126),
(149, 'Disponibilidad de Agua', 127),
...
(164, ' Manejo de vertimientos de Agua', 130),
(165, 'Emisiones en el Aire', 130),
(166, 'Residuos sólidos (peligrosos y posconsumo)', 130),
(167, 'Reglamento normativo en el Suelo', 130),
(168, 'Reglamento normativo en la Flora', 130),
(169, 'Reglamento normativo en la Fauna', 130),
...
(176, 'Impacto ambiental en Aire', 132),
(177, 'Impacto ambiental en Agua', 132),
(178, 'Impacto ambiental en Suelo', 132),
(179, 'Impacto ambiental en Flora', 132),
(180, 'Impacto ambiental en Fauna', 132),
...
INSERT INTO `opcions` (`id_opcion`, `nombre_opcion`, `id_fk_categoria`) VALUES
...
(35, 'internet, televisión, emisoras comunitarias', 182),
(36, 'Natalidad', 183),
(37, 'Mortalidad', 183),
